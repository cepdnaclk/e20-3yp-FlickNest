...
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_8_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_8_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_8 = {
    8, // uint32_t blockId
    4, // int implementationVersion
    3, // int length of axes
    0.03364737628209f, // float scale-axes
    1, // int input-decimation-ratio
    "low", // select filter-type
    10.83203125f, // float filter-cutoff
    6, // int filter-order
...
const uint32_t ei_learning_block_13_inputs[1] = { 8 };
const uint8_t ei_learning_block_13_inputs_size = 1;
const uint32_t ei_learning_block_14_inputs[1] = { 8 };
...
const ei_impulse_t impulse_685963_0 = {
    .project_id = 685963,
    .project_owner = "tharaka dilshan",
    .project_name = "symbol_mapper_cloned2",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 10,

    .nn_input_frame_size = 33,
    .raw_sample_count = 118,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 118 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 16.949152542372882,
    .frequency = 59,
...
ei_impulse_handle_t impulse_handle_685963_0 = ei_impulse_handle_t( &impulse_685963_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_685963_0;
