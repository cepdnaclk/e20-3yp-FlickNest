...
const char* ei_classifier_inferencing_categories[] = { "CIRCLE", "UPDOWN", "WAVE" };
...
ei_dsp_config_spectral_analysis_t ei_dsp_config_2 = {
    ...
    0.02447133837994f, // float scale-axes
    10, // int input-decimation-ratio
    "low", // select filter-type
    1.3828125f, // float filter-cutoff
    6, // int filter-order
...
const ei_impulse_t impulse_707236_0 = {
    .project_id = 707236,
    .project_owner = "tharaka dilshan",
    .project_name = "wristband2",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_707236_0 = ei_impulse_handle_t( &impulse_707236_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_707236_0;
